...
(function () {
    ...
    const CONFIG = {
        LOAD_MORE_BUTTON_SELECTOR: '.btn.mx-auto.flex.w-40.justify-center.rounded-full.border.border-gray-500.bg-transparent.text-white.hover\\:bg-gray-700'
    };
    /**
    ...
    function findLoadMoreButton() {
        return document.querySelector(CONFIG.LOAD_MORE_BUTTON_SELECTOR);
    }
    /**
     ...
     */
    function isElementAlmostInViewport(element) {
